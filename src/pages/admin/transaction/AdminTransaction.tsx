                                ...
                                {transactions.map((transaction: any, index: any) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            {transaction.type === 3 && `Earnings from paid bite${transaction.bite.subscription ? '(Subscription)' : ''}: [${transaction.bite.title}]`}
                                        ...
                                        <td>
                                            ...
                                            {transaction.type === 2 && <span style={{ color: '#D94E27' }}>- {transaction.bite.subscription ? 0 : currencyRate ? (getUSD(transaction.currency, transaction.localPrice)).toFixed(2) : ''}</span>}
                                            {transaction.type === 3 && <span style={{ color: '#10B981' }}>+ {transaction.bite.subscription ? 0 : currencyRate ? (getUSD(transaction.bite.currency, transaction.bite.price)).toFixed(2) : ''}</span>}
                                        ...
                                        <td>
                                            {transaction.type === 1 && <span style={{ color: '#D94E27' }}>- 0</span>}
                                            {transaction.type === 2 && <span style={{ color: '#D94E27' }}>- {transaction.bite.subscription ? 0 : getLocalCurrency(transaction.currency) + `${transaction.localPrice.toFixed(2)}`}</span>}
                                            {transaction.type === 3 && <span style={{ color: '#10B981' }}>+ {transaction.bite.subscription ? 0 : getLocalCurrency(transaction.bite.currency) + `${transaction.bite.price.toFixed(2)}`}</span>}
