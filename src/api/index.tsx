...
export const getCreatorsByCategory = (categories: any) => API.get(`/api/auth/creators?categories=${categories}`)
export const getUsersByCategory = (categories: any, search: any) => API.get(`/api/auth/list?categories=${categories}&search=${search}`)
...
export const getTransactionsByUserId = (userId: any, sort: any, period: any) => API.get(`/api/transaction/user/${userId}?sort=${sort}&period=${period}`)
...
export const getSubscribersByOwner = (userId: any, code: any, sort: any) => API.get(`/api/subscription/owner-subscribers?type=${code}&sort=${sort}&user=${userId}`)
